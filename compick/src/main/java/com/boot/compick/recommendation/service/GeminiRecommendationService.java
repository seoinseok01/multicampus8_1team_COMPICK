package com.boot.compick.recommendation.service;

import com.boot.compick.recommendation.dto.AiRecommendationResponse;
import com.boot.compick.recommendation.dto.AiProductCatalog;
...
public class GeminiRecommendationService {
    ...
    public GeminiRecommendationService(
            ...
            @Value("${gemini.product-resource:classpath:ai/compick-products.csv}") Resource productResource,
            @Value("${gemini.system-prompt-resource:classpath:ai/system-prompt.txt}") Resource promptResource,
