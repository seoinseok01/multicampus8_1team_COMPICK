...
public class Member {
	...
	public Member(String loginId, String passwordHash, String name, String email, String nickname, String phone) {
		this.loginId = loginId;
		this.passwordHash = passwordHash;
		this.name = name;
		this.email = email;
	...
	public void updateAdministration(MemberRole role, MemberStatus status) {
		this.role = role;
		this.status = status;
	}
}
