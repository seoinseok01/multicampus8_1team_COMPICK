...
public class SocialAccountService {
	...
	public GoogleLoginResult loginGoogle(String providerUserId, String rawEmail, String name) {
		return loginGoogleWithResult(providerUserId, rawEmail, name);
	}
    ...
    @Transactional
    public void completeSocialSignup(String currentLoginId, String rawPassword) {
	...
	public void setSocialPassword(String currentLoginId, String rawPassword) {
		completeSocialSignup(currentLoginId, rawPassword);
	}
